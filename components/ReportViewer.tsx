      ...
      <html>
        <head>
          ...
          <style> 
            ...
            @page {
                ...
                @bottom-center {
                    content: ${hideFooter ? '""' : `"Generated by ${state?.settings.heading || 'Knowledge Fest Manager'} - Page " counter(page)`};
        ...
        <body>
          ...
          <div class="print-footer-info">
             Generated by ${state?.settings.heading || 'Knowledge Fest Manager'}
          </div>
        </body>
      </html>
    `;
        ...
        <div className="relative flex flex-col w-full h-full max-w-5xl max-h-[95vh] bg-white dark:bg-zinc-900 rounded-[2rem] shadow-2xl overflow-hidden border border-white/10" onClick={e => e.stopPropagation()}>
          <div className="flex-shrink-0 flex items-center justify-between p-6 border-b border-zinc-200 dark:border-zinc-800 gap-6 bg-zinc-50 dark:bg-zinc-900/50">
            ...
            <div className="flex items-center gap-3">
              <button onClick={handlePrint} className="flex items-center gap-2 px-5 py-2.5 bg-brand-primary text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-lg active:scale-95 transition-all"><Printer size={16} /> Print</button>
